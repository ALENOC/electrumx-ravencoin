# ElectrumX-Ravencoin 1.13.7 offline release signing

This is the complete maintainer signing procedure for the 1.13.7 release candidate.
...
From the reviewed 1.13.7 source checkout, run exactly:
...
`status=VERIFIED`, `version=1.13.7`, `artifactRevision=0`, and the printed `keyId`
