# ElectrumX-Ravencoin 1.13.13 offline release signing

This is the complete maintainer signing procedure for the 1.13.13 release candidate.
...
From the reviewed 1.13.13 source checkout, run exactly:
...
`status=VERIFIED`, `version=1.13.13`, `artifactRevision=0`, and the printed `keyId`
