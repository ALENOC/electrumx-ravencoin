# ElectrumX-Ravencoin 1.13.11 offline release signing

This is the complete maintainer signing procedure for the 1.13.11 release candidate.
...
From the reviewed 1.13.11 source checkout, run exactly:
...
`status=VERIFIED`, `version=1.13.11`, `artifactRevision=0`, and the printed `keyId`
