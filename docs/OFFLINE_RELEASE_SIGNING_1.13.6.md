# ElectrumX-Ravencoin 1.13.6 offline release signing

This is the complete maintainer signing procedure for the 1.13.6 release candidate.
...
From the reviewed 1.13.6 source checkout, run exactly:
...
`status=VERIFIED`, `version=1.13.6`, `artifactRevision=0`, and the printed `keyId`
