...
@pytest.mark.asyncio
async def test_oversized_response_is_contained_not_raised():
...
@pytest.mark.asyncio
async def test_real_connection_honors_configured_max_response_bytes():
    ...
    try:
        limits = Limits(max_response_bytes=200_000, tcp_timeout=2, rpc_timeout=2)
        result = await probe_endpoint(
